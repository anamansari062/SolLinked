    ...
    <div class="px-8 py-4" v-else>
        <div class="flex justify-between">
            ...
            <div class="flex" v-if="isMyPost">
                <button @click="isEditing = true" class="flex px-2 rounded-full text-gray-500 hover:text-green hover:bg-gray-100" title="Update Post">
        ...
        <p class="whitespace-pre-wrap break-all font-bold" v-text="post.title"></p>
        <p class="whitespace-pre-wrap break-all" v-text="post.content"></p>
        <p class="whitespace-pre-wrap break-all text-purple" >#{{ post.tag }}</p>
