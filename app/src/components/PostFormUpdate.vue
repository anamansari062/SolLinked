...
const characterLimit = useCountCharacterLimit(content, 300)
...
const canPost = computed(() => content.value && characterLimit.value > 0)
// Actions.
...
<template>
    <div v-if="connected">
        <div class="px-8 py-4 border-l-4 border-blue-700">
            <div class="py-1">
            ...
            <div class="flex flex-wrap items-center justify-between -m-2">
                ...
                <div class="relative m-2 mr-4">
                    ...
                    <div class="absolute left-0 inset-y-0 flex pl-3 pr-2">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 m-auto" :class="slugTag ? 'text-blue-700' : 'text-gray-400'" viewBox="0 0 20 20" fill="currentColor">
                ...
                <div class="flex items-center space-x-4 m-2 ml-auto">
                    ...
                    <!-- Post button. -->
                    <button
                        class="text-white px-4 py-2 rounded-full font-semibold" :disabled="! canPost"
                        :class="canPost ? 'bg-blue-700' : 'bg-blue-500 cursor-not-allowed'"
                        @click="update"
                    >
                        Update
                    </button>
